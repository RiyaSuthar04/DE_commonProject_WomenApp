export function createWelcomeEmailTemplate(name, profileUrl) {
  ...
  <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
    <div style="background-color: #ffffff; padding: 30px; border-radius: 0 0 10px 10px; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
      ...
      <p>We're thrilled to have you join our professional community! WomenApp is your platform to connect, learn, and grow in your career.</p>
      ...
      <p>Best regards,<br>The womenApp Team</p>
    </div>
  </body>
  </html>
  `;
